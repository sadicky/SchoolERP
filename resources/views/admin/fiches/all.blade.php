...
<div class="dashboard-content-one">
    ...
    <div class="card height-auto">
        <div class="card-body">
            ...
            <hr><form action="{{ route('eleves.search') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <input type="hidden" id="eleve_id" value="{{$eleve->eleve_id}}" name="eleve_id[]">
                            ...
                            <td> <input type="text" id="note" value="{{ old('note.' . $loop->index, '') }}"  class="form-control" name="note[]" min="0" max="20" required> </td>
                            <td> <input type="text" readonly name="ponderation" class="form-control" value="{{$ponderation}}"> </td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
